$(document).ready(function(){
   var streams = [
    ...
    function showStream() {
        ...
        streams.forEach(function(data){
            //if there is a stream value, then do something
            
            if(data.stream) {
                html += "<div class='row'><img class='rounded-circle' src='" +
                    data.stream.logo + "' alt='logo'>";
                console.log(data.stream.status);
            } else {
                console.log("no data!");
            }
            html += "</div><br>"
            $(".table-dark").html(html);
            //get the keys of each object
            
//           var keys = Object.keys(data);
//            console.log(keys[1]);
//            //add a div with class 'twitch'
//            html += "<div class='twitch'>";
//            //run another forEach on the keys object
//            keys.forEach(function(innerData){
//                html += "<strong>" + innerData + "</strong>" + data[innerData]+ "<br>";
//            });
//            html += "</div><br>"
//            $("body").html(html);
//        });
